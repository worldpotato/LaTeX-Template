...
\begin{figure}[h]
	\centering
	\includegraphics[height=2cm,width=10cm]{starwars.jpg}
	\caption{scale}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25,angle=90]{starwars.jpg}
	\caption{scale}
\end{figure}
...
\begin{wrapfigure}{r}{0.3\textwidth} %this figure will be at the right
	\centering
	\includegraphics[width=0.3\textwidth]{starwars.jpg}
...
\begin{wrapfigure}{l}{0.5\textwidth} %this figure will be at the left
	\centering
	\includegraphics[width=0.5\textwidth]{starwars.jpg}
